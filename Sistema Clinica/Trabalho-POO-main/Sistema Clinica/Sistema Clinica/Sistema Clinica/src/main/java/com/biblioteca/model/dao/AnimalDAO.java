...
public class AnimalDAO {
    ...
    public void cadastrar(Animal animal) {
        if (!clienteExiste(animal.getIdCliente())) {
            System.out.println("Error: Não há  cliente cadastrado com o ID fornecido. Por favor, cadastre um cliente antes de cadastrar um animal.");
            return;
        }
